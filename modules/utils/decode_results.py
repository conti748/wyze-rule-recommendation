...
def decode_nodes(top_results, node_mapping, rule_onehot_decode):
    ...
    :param rule_onehot_decode: maps encoded rule_types to rule_types
    ...
    for top_item in top_results:
        ...
        results.append((nodeidx_dict[top_item[0][0]], nodeidx_dict[top_item[0][1]], rule_onehot_decode[top_item[1]],
